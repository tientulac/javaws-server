package com.components.javawsserver.config;
...
public class DatabaseConnection {
    private final static String DATABASE_URL_FORMAT = "jdbc:mysql://127.0.0.1/t2004e_jpa_practical?user=root";
    private final static String DATABASE_SERVER = "localhost";
    private final static int DATABASE_PORT = 8080;
    private final static String DATABASE_NAME = "t2004e_jpa_practical";
